...
a: 
  This is to account for multiple testing. A p-value of 0.05 means the probability of observing a test-statistic as extreme or more for a single tests under the null is 5%. However, when running many tests, this would correspond to many false positives observed.
...
b:
  Insufficient sample sizes is the reason why so few variants of small effect sizes that are relatively rare are detected.