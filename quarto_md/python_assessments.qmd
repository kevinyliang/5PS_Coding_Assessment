...
The package source code is on github:

https://github.com/kevinyliang/5PS_Coding_Assessment/tree/main/simple_python_GWAS_package
...
```{bash}
pip install <absolute path to>/simple_python_GWAS_package
```
...
https://github.com/kevinyliang/5PS_Coding_Assessment/blob/main/simple_python_GWAS_package/tests/test_sumstat_cleanup.py
